package com.healthcare.communityservice.service.Implementation;

import com.healthcare.communityservice.dto.*;
import com.healthcare.communityservice.entity.*;
...
import com.healthcare.communityservice.networkmanager.UserFeingClient;
import com.healthcare.communityservice.repository.*;
...
public class CommunityServiceImplementation implements CommunityService {
    ...
    public IndividualPostInfoDto getInfoOfIndividualPost(Long postId) throws ValueNotFoundException, GroupNotMatchException {
        ...
        return new IndividualPostInfoDto(
                postId,
                post.getDescription(),
                countLikes,
                comments
